(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.steve, 300, 160, 5, 0.3);
        
        collectable.create(type.steve, 400, 100, 3, 0.1);
        
        collectable.create(type.steve, 600, 120, 1, 0.5);
        
        collectable.create(type.steve, 500, 190, 8, 0.9);
